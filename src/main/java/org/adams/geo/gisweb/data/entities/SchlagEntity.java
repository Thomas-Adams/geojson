...
/**
 * Persistent class for entity stored in table "schlag"
 *
...
@Entity
@Table(name = "schlag", schema = "public")
// Define named queries here
@NamedQueries({ @NamedQuery(name = "SchlagEntity.countAll", query = "SELECT COUNT(x) FROM SchlagEntity x") })
public class SchlagEntity implements Serializable {
	...
	// ----------------------------------------------------------------------
	@Id
	@SequenceGenerator(name = "my_sa_seq", sequenceName = "schlag_gid_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "my_sa_seq")
